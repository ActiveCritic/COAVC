...
def run_eval_stats_env(device, weight_decay):
    ...
    data_path = '/data/author_2/author_1/AC_var_' + s
    env_tag = 'drawerclose'
    val_every = 1000
    add_data_every = 1000
    opt_mode = 'actor+plan'
...
load_path = '/data/author_2/author_1/AC_var_2023-03-31/drawerclose ms 0 explore_until 50 100 drawerclose opt steps: 3 trainin eps: 500 opt mode: actor+plan demonstrations: 0, im_ph:False, training_episodes: 10, min critic: 1e-05, wd: 0.01, val_every: 1000 run id: 0/inter_models/latest/'
acll = acl[0]
